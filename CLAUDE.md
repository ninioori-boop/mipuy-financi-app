...
[ ] יעדים פיננסיים: לחץ "הוסף מטרה" → שורה חדשה מופיעה
[ ] יעדים פיננסיים: מלא ערכים → רענן → ערכים נשמרו
[ ] טאב תכנון שנתי: הזן ערכים → רענן → ערכים נשמרו
[ ] בידוד משתמשים: התנתק → התחבר עם משתמש אחר → מסך ריק (לא רואה נתונים קודמים)
[ ] tests.html: פתח בדפדפן → כל הבדיקות ירוקות
```
